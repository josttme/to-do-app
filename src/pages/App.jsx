	...
	return (
		<>
			...
			<section className=" relative text-center text-white">
				...
				{isAllTodosCompleted && (
					<div className="relative mx-auto flex w-11/12 max-w-xs flex-col gap-2 rounded-lg bg-[#0236c5] p-4 ">
						<span className="px-2 py-5 text-center text-xl text-white">
							¡Felicidades! Has completado todas tus tareas. 😳
						</span>
						<button
							type="button"
							aria-label="Close"
							className="absolute right-1 top-1 rounded-full bg-black/20 p-1  hover:bg-black/40"
